...
export default function templateImpressionEndpoint_love() {
    const router = Router()
    router.post('/love/:templateId', checkPermission(PERMISSION_LIST.MAKE_IMPRESSION), validation, controller)
    return router
}
