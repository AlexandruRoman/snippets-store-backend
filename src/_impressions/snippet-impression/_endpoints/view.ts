...
export default function snippetImpressionEndpoint_view() {
    const router = Router()
    router.post('/view/:snippetId', checkPermission(PERMISSION_LIST.MAKE_IMPRESSION), validation, controller)
    return router
}
