...
import { Role } from 'src/_identity/role/schema'
import { User, IUserModel } from 'src/_identity/user/schema'
import { IPermissionRequest } from 'src/__helpers/api'
import { userService_add } from 'src/_identity/user/service'
import { clientService_add } from 'src/_identity/client/service'
...
async function controller(req: IRequest, res: Response) {
    try {
        const userModel = await clientService_add(req.body)
